...
function handleGet() {
	...
	if(customerId === "" || dateYear === "" || dateMonth === "")
	{
...
//STEP 1
	...
	var queryStr = 'SELECT TOP 5 TASK_TYPE, CPU_TOTAL, DB_TOTAL, CPU_DB_TOTAL FROM "SMART_OPERATION"."CMWLH" WHERE CUSTOMER_ID = ? AND DATE_Y = ? AND DATA_M = ? ORDER BY CPU_DB_TOTAL DESC';
